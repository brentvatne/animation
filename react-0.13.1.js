...
var CSSPropertyOperations = {
   ...
   * @return {?string}
   */
  createMarkupForStyles: function(node, styles) {
    var serialized = '';
    for (var styleName in styles) {
      ...
      if (styleValue != null) {
        ...
        if (styleValue && typeof styleValue === 'object' && 'addBinding' in styleValue) {
          styleValue.addBinding(new ReactStyleBinding(node, styleName));
        }
      }
    }
  ...
  setValueForStyles: function(node, styles) {
    ...
    for (var styleName in styles) {
      ...
      var styleValue = styles[styleName];
      if (styleValue && typeof styleValue === 'object' && 'addBinding' in styleValue) {
        styleValue.addBinding(new ReactStyleBinding(node.getAttribute('data-reactid'), styleName));
      }
    ...
    for (var propKey in props) {
      ...
      if (registrationNameModules.hasOwnProperty(propKey)) {
        ...
        if (propKey === STYLE) {
          ...
          propValue = CSSPropertyOperations.createMarkupForStyles(this._rootNodeID, propValue);
        }
        var markup =
